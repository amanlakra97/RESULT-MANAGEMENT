...
<div class="sidenav">
  ...
  <div class="dropdown-container">
    <a href="/rp/analysis/6semanalysis.php">1 Semester</a>
...
<?php
$sql="select total_theory,count(regno) as distinction from 6sem where total_theory between 507 and 675";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d1=$rs['distinction'];
	}
$sql="select total_theory,count(regno) as first from 6sem where total_theory between 412 and 506";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d2=$rs['first'];
	}
$sql="select total_theory,count(regno) as second from 6sem where total_theory between 360 and 411";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d3=$rs['second'];
	}
$sql="select total_theory,count(regno) as pass from 6sem where total_theory between 262 and 359";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d4=$rs['pass'];
	}
$sql="select total_theory,count(regno) as minimum from 6sem where total_theory between 1 and 261";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d5=$rs['minimum'];
	}
...
<div class="btn9">
<form action="6totaltheory.php" method="post">
