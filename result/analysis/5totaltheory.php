...
<div class="sidenav">
  ...
  <div class="dropdown-container">
    <a href="/rp/analysis/5semanalysis.php">1 Semester</a>
...
<?php
$sql="select total_theory,count(regno) as distinction from 5sem where total_theory between 511 and 680";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d1=$rs['distinction'];
	}
$sql="select total_theory,count(regno) as first from 5sem where total_theory between 416 and 510";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d2=$rs['first'];
	}
$sql="select total_theory,count(regno) as second from 5sem where total_theory between 346 and 415";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d3=$rs['second'];
	}
$sql="select total_theory,count(regno) as pass from 5sem where total_theory between 259 and 345";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d4=$rs['pass'];
	}
$sql="select total_theory,count(regno) as minimum from 5sem where total_theory between 1 and 258";
$query=mysqli_query($con,$sql);
while($rs=mysqli_fetch_assoc($query)){
	$d5=$rs['minimum'];
	}
...
<div class="btn9">
<form action="5totaltheory.php" method="post">
