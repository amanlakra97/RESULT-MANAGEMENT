...
<th>BCA402T(ENGLISH) THEORY</th>
<th>BCA402T(ENGLISH) INTERNAL</th>
<th>BCA403T(VP) THEORY</th>
<th>BCA403T(VP) INTERNAL</th>
<th>BCA404T(UNIX) THEORY</th>
<th>BCA404T(UNIX) INTERNAL</th>
<th>BCA405T(OR) THEORY</th>
<th>BCA405T(OR) INTERNAL</th>
<th>BCA403P(VP LAB) THEORY</th>
<th>BCA403P(VP LAB) INTERNAL</th>
<th>BCA404P(UNIX LAB) THEORY</th>
<th>BCA404P(UNIX LAB) INTERNAL</th>
<th>SDC THEORY</th>
<th>SDC INTERNAL</th>
<th>CCEC</th>
<th>TOTAL THEORY</th>
...
<th>RESULT</th>
  ...
  <?php
  $query="select * from 4sem";
   $query_run = mysqli_query($con,$query);

  
     if($query_run -> num_rows > 0){
		 while($row =$query_run -> fetch_assoc()){
			 echo "<tr><td>".$row["regno"]."</td><td>".$row["name"]."</td><td>".$row["il_theory"]."</td><td>".$row["il_internal"]."</td><td>".$row["english_theory"]."</td><td>".$row["english_internal"]."</td><td>".$row["vp_theory"]."</td><td>".$row["vp_internal"]."</td><td>".$row["unix_theory"]."</td><td>".$row["unix_internal"]."</td><td>".$row["or_theory"]."</td><td>".$row["or_internal"]."</td><td>".$row["vp_lab_theory"]."</td><td>".$row["vp_lab_internal"]."</td><td>".$row["unix_lab_theory"]."</td><td>".$row["unix_lab_internal"]."</td><td>".$row["sdc_theory"]."</td><td>".$row["sdc_internal"]."</td><td>".$row["ccec"]."</td><td>".$row["total_theory"]."</td><td>".$row["total_internal"]."</td><td>".$row["gpa"]."</td><td>".$row["grade"]."</td><td>".$row["result"]."</td></tr>";
